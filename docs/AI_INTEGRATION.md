...
The Emergent Universal Key (`sk-emergent-3B425A670251f7379B`) works with the `emergentintegrations` Python library, which is not compatible with Next.js/Node.js applications. 
...
# EMERGENT_LLM_KEY=sk-emergent-3B425A670251f7379B
