  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (staff) {
        ...
        toast({ title: 'Success', description: 'Staff member updated successfully', variant: 'default' })
      } else {
        ...
        toast({ title: 'Success', description: 'Staff member created successfully', variant: 'default' })
      }
      onSuccess()
      onOpenChange(false)
    } catch (error) {
