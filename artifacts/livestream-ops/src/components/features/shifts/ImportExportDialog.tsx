...
export function ImportExportDialog({ open, onOpenChange, shifts, brands, platforms, campaigns, users, onSuccess }: ImportExportDialogProps) {
  ...
  const handleExport = () => {
    ...
    toast({ title: 'Success', description: 'Shifts exported to Excel', variant: 'default' })
  }
  ...
  const confirmImport = async () => {
    ...
    try {
      ...
      toast({ title: 'Success', description: `Imported ${importResult.validRows} shifts`, variant: 'default' })
      onSuccess()
      onOpenChange(false)
