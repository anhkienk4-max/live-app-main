...
import { shiftService, brandService, platformService, campaignService, userService, templateService } from '@/lib/services/dataService'
...
export function ShiftList() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (success) {
      toast({ title: 'Success', description: 'Shift deleted', variant: 'default' })
      loadData()
    }
  }
  ...
  const handleBulkDelete = async (ids: string[]) => {
    ...
    toast({ title: 'Success', description: `${ids.length} shifts deleted`, variant: 'default' })
