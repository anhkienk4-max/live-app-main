...
export function CampaignList() {
  ...
  return <>
    ...
    <Dialog open={formOpen} onOpenChange={setFormOpen}><DialogContent size="xl" >
<DialogHeader><DialogTitle>{selected ? t('edit') : t('create')} {t('campaign')}</DialogTitle><DialogDescription>{t('campaignPreviewHelp')}</DialogDescription></DialogHeader>
