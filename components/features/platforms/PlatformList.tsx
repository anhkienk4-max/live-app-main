...
<DialogHeader><DialogTitle>{selected ? t('edit') : t('create')} {t('platform')}</DialogTitle><DialogDescription>{t('credentialsSafe')}</DialogDescription></DialogHeader>
