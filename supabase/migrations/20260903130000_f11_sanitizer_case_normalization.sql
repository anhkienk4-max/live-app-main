-- Core V1 F11 Patch-2: normalize audit sanitizer keys before filtering.
-- This forward-only replacement preserves the recursive implementation and
-- audit trigger contract while fixing mixed-case/camel-case key handling.
