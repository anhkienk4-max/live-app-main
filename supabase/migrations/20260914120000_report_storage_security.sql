...
-- Production report_images has ZERO rows; no data migration needed.
...
create policy "report-images-authenticated-read"
  ...
  using (
    ...
    and (
      -- reports/ prefix: user can see the parent report
      (
      ...
      or
      -- live/ prefix: user can see the parent report
      (
